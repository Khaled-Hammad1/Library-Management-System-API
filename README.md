...
The database currently supports the roles:
...
Role-based authentication and authorization are planned as a future improvement.

For example, administrative operations such as adding, updating, or deleting library items can later be protected using:
...
The core library management, borrowing, returning, searching, and reporting APIs are implemented.

Authentication, authorization, DTOs, validation, testing, and architectural improvements are planned for the next development phase.

---

## 👨‍💻 Author

Developed as a backend development project using **ASP.NET Core Web API, Entity Framework Core, and SQL Server**.
